<x-layout ><div class="container py-md-5">
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/registerNewUser" method="POST" id="registration-form">
            @csrf
           ...
           @error('username')
              <p class="mt-1 ml-4 mr-4 small alert alert-danger shadow-sm">{{$message}}</p>
           @enderror
            </div>
